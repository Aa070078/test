        ...
        async def main():
            ...
            def fetch_data():
                ...
                headers = {
                    ...
                    "blade-auth":
                    "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9..GkpkdJ-Ak1BEK1-O4Tjr5sHrs2q9r6wUpx8acG_gtadgm8umV78oNwQq_C_KsytD9jcCvYVis7DpPeOYWfZmcQ",
                    "user-agent":
            ...
            def signal_data(start_time, end_time):
                ...
                url = f"https://m.coinvidg.com/api/rocket-api/contract/market/kline-history?symbol=BTC/USDT&from=1740215361077&to={end_time2}&period=1min"
                headers = {
                    "accept":
                    "application/json, text/plain, */*",
                    "authorization":
